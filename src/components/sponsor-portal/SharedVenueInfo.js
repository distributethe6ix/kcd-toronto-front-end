      ...
      <div className="columns">
        <div className="column is-5">
          ...
          <table className="table is-narrow is-fullwidth">
            <tbody>
              <tr><td><strong>Load-in Date</strong></td><td>{venueInfo.loadInDate}</td></tr>
              <tr><td><strong>Load-in Time</strong></td><td>{venueInfo.loadInTime}</td></tr>
              <tr><td><strong>Load-out Date</strong></td><td>{venueInfo.loadOutDate}</td></tr>
              <tr><td><strong>Load-out Time</strong></td><td>{venueInfo.loadOutTime}</td></tr>
            </tbody>
          </table>
